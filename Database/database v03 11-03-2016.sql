...
insert  into `products`(`id`,`category`,`name`,`min_order`,`description`,`created_time`,`price`,`is_deleted`,`owner_id`,`photo_path`) values ('eidz_V0nQU2EpSp9_uHEtg',12,'Pomegranat KABLAMMO!',0,NULL,'2016-03-11 23:27:41',150000,0,2,'Bomb.png');
