                            ...
                            <div class="col-md-4 item-grid1 simpleCart_shelfItem" style="width: 60%;">
                                <div class=" mid-pop">
                                    <div class="pro-img">
                                        ...
                                        <div class="zoom-icon ">
                                            <a class="picture" href='<%# String.Format("../Image/product/{0}", ((KomoLine.Data.Model.Product)Container.DataItem).PhotoPath )%>' class="b-link-stripe b-animate-go  thickbox">
                                    ...
                                    <div class="mid-1">
                                        <div class="women">
                                            <div class="women-top">
                                                ...
                                                <h6>
                                                    <asp:HyperLink NavigateUrl='<%# String.Format("ProductDetail.aspx?id={0}", ((KomoLine.Data.Model.Product)Container.DataItem).ID )%>' runat="server"><%# ((KomoLine.Data.Model.Product)Container.DataItem).Name %></asp:HyperLink></h6>
                                            </div>
